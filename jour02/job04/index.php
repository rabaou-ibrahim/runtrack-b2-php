<?php
function find_all_students_grades(string $email, string $fullname, string $grade_name, DateTime $year) : array {
...
<body>
    <?php
        $grades = ['email' => $email, 'fullname' => $fullname, 'grade_name' => $grade_name, 'grade_name', 'year' => $year];
    ?>
</body>
</html>